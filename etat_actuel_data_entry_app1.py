...
<p style="font-size:16px; line-height:1.55; color:{USJ_BLUE}; margin-bottom:0;">
    M. Hadi Sawaya – Coordinateur de l’Unité Assurance Qualité :
    <a href="mailto:hadi.sawaya@usj.edu.lb" style="color:{USJ_BLUE}; text-decoration:underline;">hadi.sawaya@usj.edu.lb</a>
    | <a href="https://outlook.office.com/mail/deeplink/compose?to=hadi.sawaya@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Outlook/Hotmail</a>
    | <a href="https://mail.google.com/mail/?view=cm&fs=1&to=hadi.sawaya@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Gmail</a><br>

    Mme Irma Majdalani – Expert qualité – Unité Assurance qualité :
    <a href="mailto:irma.majdalani@usj.edu.lb" style="color:{USJ_BLUE}; text-decoration:underline;">irma.majdalani@usj.edu.lb</a>
    | <a href="https://outlook.office.com/mail/deeplink/compose?to=irma.majdalani@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Outlook/Hotmail</a>
    | <a href="https://mail.google.com/mail/?view=cm&fs=1&to=irma.majdalani@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Gmail</a><br>

    Mme Nadine Riachi Haddad – Secrétaire général :
    <a href="mailto:secg@usj.edu.lb" style="color:{USJ_BLUE}; text-decoration:underline;">secg@usj.edu.lb</a>
    | <a href="https://outlook.office.com/mail/deeplink/compose?to=secg@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Outlook/Hotmail</a>
    | <a href="https://mail.google.com/mail/?view=cm&fs=1&to=secg@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Gmail</a><br>

    Mme Ursula El Hage – Directeur du Service de l’insertion professionnelle :
    <a href="mailto:ursula.hage@usj.edu.lb" style="color:{USJ_BLUE}; text-decoration:underline;">ursula.hage@usj.edu.lb</a>
    | <a href="https://outlook.office.com/mail/deeplink/compose?to=ursula.hage@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Outlook/Hotmail</a>
    | <a href="https://mail.google.com/mail/?view=cm&fs=1&to=ursula.hage@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Gmail</a><br>

    Mme Lina Koleilat Ghalayini – Chef de projets – Unité Assurance qualité :
    <a href="mailto:lina.koleilat@usj.edu.lb" style="color:{USJ_BLUE}; text-decoration:underline;">lina.koleilat@usj.edu.lb</a>
    | <a href="https://outlook.office.com/mail/deeplink/compose?to=lina.koleilat@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Outlook/Hotmail</a>
    | <a href="https://mail.google.com/mail/?view=cm&fs=1&to=lina.koleilat@usj.edu.lb" target="_blank" style="color:{USJ_BLUE}; text-decoration:underline;">Gmail</a>
</p>
</div>
""")
